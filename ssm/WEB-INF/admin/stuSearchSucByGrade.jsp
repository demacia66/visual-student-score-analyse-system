  ...
  <div>
    ...
    <s:iterator value="simpleStudents" status="st">  
       <tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';" <s:if test="#st.odd">class="altrow"</s:if> >  
          ...
          <td><a href="stuModify.action?xuehao=<s:property value="xuehao"/>"><input type="button" value="修改" /></a>&nbsp;&nbsp;
              <a href="stuSeeing.action?xuehao=<s:property value="xuehao"/>"><input type="button" value="查看" /></a>&nbsp;&nbsp;
