...
.datalist tr.altrow{
 ...
 <jsp:include page="scoreServiceNavigation.jsp"></jsp:include>
  <div id="accordion">
  	<h3>成绩管理——成绩修改</h3>
  	<div class="frame">
  	<form action="scoreModifyResult.action" method="post" id="myForm1">
  	<table class="datalist">
  		  		<tr><td>学号：<input type="text" name="stuXueHao" id="stuXueHao1" />&nbsp;&nbsp;&nbsp;学期：<select name="xueqi" id="xueqi1">
  		  		...
  		  		</select>&nbsp;&nbsp;&nbsp;<input type="button" name="btn1" value="查询-修改" /></td>
  		  		</tr>
  	</table>
  	</form>
 
  	<form action="scoreModifyResultGrade.action" method="post" id="myForm2">
  	<table class="datalist">
  		<tr><td>班级：<select name="gradeID" id="gradeID2">
  			<s:iterator value="grades">
  				<option value='<s:property value="bianHao" />' > <s:property value="year" />届（<s:property value="classID" />）班 </option>
  		  		...
  		  		</select>&nbsp;&nbsp;&nbsp;<input type="button" name="btn2" value="查询-修改" /></td>
  		  		</tr>
  	</table>
  	</form>
  	</div>
