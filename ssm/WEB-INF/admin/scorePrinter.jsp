...
.datalist tr.altrow{
 ...
 <jsp:include page="scoreServiceNavigation.jsp"></jsp:include>
  <div id="accordion">
  	<h3>成绩管理——成绩打印</h3>
  	<div class="frame">
  	<form action="scorePrinterSuc.action" method="post" id="myForm1">
  	<table class="datalist">
  		  		<tr><td>学号：<input type="text" name="stuXueHao" id="stuXueHao" />&nbsp;&nbsp;&nbsp;学期：<select name="xueqi" id="xueqi">
  		  		...
  		  		</select>&nbsp;&nbsp;&nbsp;类型：<select name="examType" id="examType">
  		  			<option value="期中">期中</option>
  		  			<option value="期末">期末</option>
  		  		</select>&nbsp;&nbsp;&nbsp;<input type="button" name="btn" value="查询-打印" /></td>
  		  		</tr>
  	</table>
  	</form>
  	
  	  	<form action="scorePrinterGradeSuc.action" method="post" id="myForm2">
  	<table class="datalist">
  		<tr><td>班级：<select name="gradeID" id="gradeID1">
  			<s:iterator value="grades">
  				<option value='<s:property value="bianHao" />' > <s:property value="year" />届（<s:property value="classID" />）班 </option>
  		  			...
  		  			<option value="期中">期中</option>
  		  			<option value="期末">期末</option>
  		  		</select>&nbsp;&nbsp;&nbsp;<input type="button" name="btn1" value="查询-打印" /></td>
  		  		</tr>
  	</table>
  	</form>
  	</div>
