...
<div>
	...
	<div id="accordion">
		<h3>学生管理&nbsp;&gt;&nbsp;学生基本信息查看</h3>
		<div align="left" >
			 <p> <strong><s:property value="student.name" />同学的<span style="color:red">基本个人信息</span></strong> </p>
			 <hr>
			...
			<p> <strong><s:property value="student.name" />同学的<span style="color:red">学习情况</span></strong> </p>
			<hr>
			 <img alt="" src='scoreAnalyze.action?stuXueHao=<s:property value="xuehao" />&stuName=<s:property value="student.name" />&year=<s:property value="grade.year" />&classID=<s:property value="grade.classID"/>' width="1000" height="500" />
		</div>
	</div>
</body>
</html>